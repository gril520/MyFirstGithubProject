...
<script type="text/javascript">
	function deleteStudent(){
		...
		$.messager.confirm("系统提示","您确认要删掉这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
			if(r){
				$.post("${pageContext.request.contextPath }/StudentDeleteServlet",{delIds:ids},function(result){
					if(result.success){
	...
	function openStudentAddDialog(){
		...
		url="${pageContext.request.contextPath }/StudentSaveServlet";
	}
	...
	function openStudentModifyDialog(){
		...
		$("#fm").form("load",row);
		url="${pageContext.request.contextPath }/StudentSaveServlet?stuId="+row.stuId;
	}
...
<body style="magrn:5px">
	...
	pagination="true" rownumbers="true"  fit="true" url="${pageContext.request.contextPath }/StudentListServlet"  toolbar="#tb"> 
		<thead>
			<tr>
	...
	<div id="dlg" class="easyui-dialog" style="width: 570px;height: 350px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				...
				<tr>
					<td>班级名称：</td>
					<td><input class="easyui-combobox" id="gradeId" name="gradeId"  data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'gradeName',url:'${pageContext.request.contextPath }/GradeComboListServlet'"/></td>
					<td></td>
					<td>Email：</td>
